...
public class CustomerMapActivity  extends AppCompatActivity implements OnMapReadyCallback, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        View hamburgerIcon = findViewById(R.id.hamburger_icon);
...
/*
    ...
    private void getClosestDriver(){
        DatabaseReference driverLocation = FirebaseDatabase.getInstance().getReference().child("driversAvailable");
         System.out.println("Drives available "+driverLocation);
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                if (!driverFound && requestBol){
                   ...
                   System.out.println("Dtata drefernce is "+mCustomerDatabase);
                    mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            System.out.println("Entered inside closestdriver ");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_account) {
            ...
            startActivity(intent);
              ...
              Intent intent=new Intent(CustomerMapActivity.this,chatgpt.class);
            startActivity(intent);
